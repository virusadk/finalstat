    ...
    with open('sr.txt','r') as file:
        ...
        if str(idl) in list1:
            ...
            with open('sr.txt','a') as file:
                ...
                SN, L, O1, O2,S,CPS,S1,S2,S21,S22,S31,S32,ST,STR,RES,K1,K2 = message.values()
                SP = S + 3*60*60
        ...
        for item in file.readlines():
            ...
            if 'False' in line:
                sfalsef = sfalsef + 1
                            ...
                            # ln = int(line)
        file.close()
    format_mess_static(struef,sfalsef,struer,sfalser)
    
def format_mess_static(struef,sfalsef,struer,sfalser):
