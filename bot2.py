            ...
            if str(idlive) == line:
                ...
                if str(idlive) in listdb:
                    ...
                    try:
                        ...
                        kefp1 = ' '
                        kefp2 = ' '
                    if (('P1' in pobed) and (float(kef1)<=4.5) and (float(kef2)<=4.5) and (int(set2) >= 20) and (float(kefp2) > 1.6)) or (('P2' in pobed) and (float(kef1)<=4.5) and (float(kef2)<=4.5) and (int(set2) < 20) and (float(kefp2) > 1.6)) :
                        ...
                        try:    
                            ...
                            print('Невозможно записать в файл db.txt')
                        file.close() 
                    # if ('P2' in pobed) and (float(kef1)<=4.5) and (float(kef2)<=4.5) and ((int(set1) >= 19) or (int(set2) >= 19)) and (float(kefp1) > 1.6):
                      if (('P2' in pobed) and (float(kef1)<=4.5) and (float(kef2)<=4.5) and (int(set2) >= 20) and (float(kefp2) > 1.6)) or (('P1' in pobed) and (float(kef1)<=4.5) and (float(kef2)<=4.5) and (int(set2) < 20) and (float(kefp2) > 1.6)) :
